	...
	public partial class LockForm : Form
	{
		...
		private void FormClose()
		{
			...
			if (valid > 0)
			{
				if (valid == 2)
				{
					var result = MessageBox.Show("Do you want create the folder..", "Directory not found", MessageBoxButtons.YesNo,
			...
			{
				var result = MessageBox.Show("Do you want overwrite the file..", "File Already Exists", MessageBoxButtons.YesNo,
					MessageBoxIcon.Warning);
				if (result == DialogResult.Yes)
				{
					SaveFileName = tboxFileName.Text;
